...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="路东"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="15800888888"/>
	<input type="hidden" name="orderShipping.receiverState" value="天津"/>
	<input type="hidden" name="orderShipping.receiverCity" value="天津"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="大港"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="南开大学滨海学院"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>路东&nbsp;&nbsp;&nbsp;&nbsp;15800888888&nbsp;&nbsp;&nbsp;&nbsp;天津&nbsp;&nbsp;大港&nbsp;&nbsp;南开大学滨海学院</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>ssm速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
